...
import { mainnet, sepolia, hardhat, polygon, bsc } from 'wagmi/chains';
...
// Supported chains - Polygon and BSC are primary for QuantMissionAI
const chains = [polygon, bsc, mainnet, sepolia, hardhat] as const;
...
export const CONTRACT_ADDRESSES = {
  [polygon.id]: {
    ...
    TRADING_BOT: '',
    TOKEN: '',
    QUANT_MISSION: process.env.NEXT_PUBLIC_QUANT_MISSION_POLYGON || '0x1D9D5E1e4627578eea3Ee427e139Af648cdd4cF3',
  },
  [bsc.id]: {
    PORTFOLIO_MANAGER: '',
    TRADING_BOT: '',
    TOKEN: '',
    QUANT_MISSION: process.env.NEXT_PUBLIC_QUANT_MISSION_BSC || '0x6C61ffa61b118eE26172D491eade295dd83f7450',
  },
  [mainnet.id]: {
    ...
    QUANT_MISSION: process.env.NEXT_PUBLIC_QUANT_MISSION_MAINNET || '',
  },
  [sepolia.id]: {
    ...
    QUANT_MISSION: process.env.NEXT_PUBLIC_QUANT_MISSION_SEPOLIA || '',
  },
  [hardhat.id]: {
    ...
    QUANT_MISSION: process.env.NEXT_PUBLIC_QUANT_MISSION_HARDHAT || '0x5FbDB2315678afecb367f032d93F642f64180aa3',
  },
} as const;
